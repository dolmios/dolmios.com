...
import { useAudio, Grid, Tag, Text } from '../components';
    ...
    <Grid>
      <Grid as='section' direction='row'>
        ...
        <Grid direction='column' width={60} widthCollapse={70} top={6} bottom={6}>
          <Text bold>
            I'm a frontend developer based in Brooklyn, NY. I am currently working on technology for short-term rentals
            at{' '}
          ...
          <Text top={5} bottom={5}>
            My best work is with React (Next.js) and TypeScript. I'm interested in developing for the web, and
            optimizing for performance and cogent code.
          </Text>

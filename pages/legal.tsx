...
export default function Legal(): JSX.Element {
  return (
    <Grid top={6} bottom={6}>
      ...
      <Text as="p">
        This site is hosted by Vercel. You can find their privacy policy on their website.
      </Text>
      <Text as="p">
        This site uses Pirsch Analytics to collect anonymous data about visitors. You can find their

          ...
          <tbody>
            ...
            <tr>
              <td colSpan={2} className="justify">
                Extensive experience with applying analytical and numerical methods (such as the
                finite element method) to model a broad range of systems from molecular structures
                to large-scale mechanical structures. Proven track record of creating and improving
                new computational methods to perform dynamic and static analysis of otherwise
                intractable engineering and biological systems. Strong ability to collaborate and
                work in a team environment on multi-disciplinary projects. Legally authorized to
                work in the United States (Green Card holder).
              </td>
            </tr>
            ...
            <tr>
              <td colSpan={2} className="list">
                &bull; Developed, implemented, and maintained the company's website, database, and
                backend systems.
              </td>
            </tr>
            <tr>
              <td colSpan={2} className="list">
                &bull; Designed and developed a web application for the company's clients to view
                their data, and interact with the company's database alongside API's and other
                integrated systems.
              </td>
            </tr>
            <tr>
            ...
            <tr>
              <td colSpan={2} className="list">
                &bull; Provided website design and development services for small-medium sized
                businesses and organizations across multiple sectors.
              </td>
            </tr>
            <tr>
              <td colSpan={2} className="list">
                &bull; Noted clients include Crime Stoppers Victoria, Irrigated Cropping Council,
            ...
            <tr>
              <td colSpan={2} className="list">
                &bull; Web development for a wide range of clients, including web platforms,
                e-commerce sites, and large-scale website projects.
              </td>
            </tr>
            <tr>
              <td colSpan={2} className="list">
                &bull; Oversaw documentation for all internal and external projects, including
                development of project data flows.
              </td>
            </tr>
            <tr>
              <td colSpan={2} className="list">
                &bull; Utilized Zendesk to provide customer service and sales service for general
                IT.
              </td>
            </tr>
            <tr>
            ...
            <tr>
              <td colSpan={2} className="concat">
                <b>Front-End:</b> Next.js, Typescript, React, Redux, HTML/CSS (SASS, Styled
                Components, et. al.), Javascript (ES6+),
              </td>
            </tr>
            <tr>
              <td colSpan={2} className="concat">
            ...
            <tr>
              <td colSpan={2} className="concat">
                <b>Information Technology:</b> Zendesk, Intercom, Hubspot, Slack, Notion, Adobe
                Photoshop
              </td>
            </tr>
            <tr>
            ...
            <tr>
              <td colSpan={2} className="list">
                &bull; Academic Scholarship; Percentile rank: 99.6 (2012, Australian Council for
                Educational Research Testing)
              </td>
            </tr>
            <tr>
            ...
            <tr>
              <td className="list" colSpan={2}>
                Contributed to recruitment and organization policy, alongside managing the
            ...
            <tr>
              <td colSpan={2} className="list">
                &bull; Local outreach raising awareness, collecting donations and fielding questions
                regarding homeless services and social services.
              </td>
            </tr>
            <tr>
            ...
            <tr>
              <td colSpan={2} className="list">
                &bull; Prepared birthing kits for distribution overseas, for women without access to
                sound medical care.
              </td>
            </tr>
            <tr>
            ...
            <tr>
              <td className="list">
                &bull; Attained Permanent Residency status in the United States of America.
              </td>
